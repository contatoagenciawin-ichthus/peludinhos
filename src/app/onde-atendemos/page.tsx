...
export const metadata: Metadata = { title: "Onde a Dra. Daniela atende", alternates: { canonical: "/onde-atendemos" } };
    ...
    <section className="section">
      <div className="container">
        <div className="narrow">
          ...
          <p className="lead">A agenda é centralizada na disponibilidade da Dra. Daniela. O WhatsApp da Peludinhos orienta sobre o local e horário compatíveis sem criar agendas paralelas por clínica.</p>
        </div>
